...
typedef TMilli ConInTagC__Timer0__precision_tag;
...
static void ConInTagC__Timer0__fired(void );
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void ConInTagC__AMSendTag__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 49 "/opt/tinyos-2.1.1/tos/interfaces/Boot.nc"
static void ConInTagC__Boot__booted(void );
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
static 
#line 63
message_t * 
...
ConInTagC__AMReceiveTag__receive(
#line 60
message_t * msg, 
void * payload, 
...
uint8_t len);
# 92 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static void ConInTagC__RadioControl__startDone(error_t error);
#line 117
static void ConInTagC__RadioControl__stopDone(error_t error);
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void ConInTagC__AMSendControl__sendDone(
#line 92
message_t * msg, 
...
ConInTagC__AMReceiveControl__receive(
#line 60
message_t * msg, 
void * payload, 
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
/*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static void /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 85
message_t * msg, 
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
/*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static void /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__sendDone(
#line 85
message_t * msg, 
...
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void ConInTagC__Timer0__startPeriodic(uint32_t dt);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t ConInTagC__AMSendTag__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
ConInTagC__AMSendTag__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static error_t ConInTagC__RadioControl__start(void );
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t ConInTagC__AMSendControl__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
ConInTagC__AMSendControl__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 56 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
static void ConInTagC__Leds__led0Toggle(void );
#line 72
static void ConInTagC__Leds__led1Toggle(void );
#line 89
static void ConInTagC__Leds__led2Toggle(void );
# 19 "ConInTagC.nc"
message_t ConInTagC__tag_pkt;
message_t ConInTagC__car_pkt;

uint16_t ConInTagC__SendA = 0;
uint16_t ConInTagC__SendB = 0;
uint16_t ConInTagC__SendC = 0;
uint16_t ConInTagC__SendD = 0;
uint16_t ConInTagC__SendE = 0;

static inline void ConInTagC__Boot__booted(void );




static inline void ConInTagC__RadioControl__startDone(error_t err);




static inline void ConInTagC__RadioControl__stopDone(error_t err);

static inline message_t *ConInTagC__AMReceiveControl__receive(message_t *msg, void *p, uint8_t len);
#line 78
static inline message_t *ConInTagC__AMReceiveTag__receive(message_t *msg, void *p, uint8_t len);
#line 116
static inline void ConInTagC__AMSendTag__sendDone(message_t *m, error_t err);
static inline void ConInTagC__AMSendControl__sendDone(message_t *m, error_t err);

static inline void ConInTagC__Timer0__fired(void );
# 92 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
...
message_t *msg);
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static error_t /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 56
message_t * msg, 
...
/*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__getPayload(
#line 111
message_t * msg, 
...
uint8_t len);
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
static void /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 147
message_t * amsg, 
...
am_id_t t);
# 45 "/opt/tinyos-2.1.1/tos/system/AMQueueEntryP.nc"
static error_t /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
...
static inline void */*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__getPayload(message_t *m, uint8_t len);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static error_t /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__send(
#line 56
message_t * msg, 
...
/*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__getPayload(
#line 111
message_t * msg, 
...
uint8_t len);
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
static void /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setType(
#line 147
message_t * amsg, 
...
am_id_t t);
# 45 "/opt/tinyos-2.1.1/tos/system/AMQueueEntryP.nc"
static error_t /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__sendDone(message_t *m, error_t err);
...
static inline void */*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__getPayload(message_t *m, uint8_t len);
...
# 88 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x41263688, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x41263688, msg);
#line 88
}
#line 88
...
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x40ec2388){
#line 118
  unsigned char __nesc_result;
#line 118

#line 118
  switch (arg_0x40ec2388) {
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x40ec2388);
#line 118
      break;
#line 118
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x40ec2dd8){
#line 39
  union __nesc_unnamed4279 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x40ec2dd8);
#line 39
...
# 87 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x40ec2388){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x40ec2388);
#line 87
      break;
#line 87
    }
...
# 78 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x40ec2388){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x40ec2388);
#line 78
      break;
#line 78
    }
...
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x40ec2388){
#line 110
  unsigned char __nesc_result;
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x40ec2388);
#line 110
      break;
#line 110
    }
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 99
  ConInTagC__AMSendControl__sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__sendDone(message_t * msg, error_t error){
#line 99
  ConInTagC__AMSendTag__sendDone(msg, error);
#line 99
}
#line 99
# 57 "/opt/tinyos-2.1.1/tos/system/AMQueueEntryP.nc"
...
#line 57
{
  /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__sendDone(m, err);
}
...
#line 89
    case 0U:
#line 89
      /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    case 1U:
#line 89
      /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    default:
...
# 59 "/opt/tinyos-2.1.1/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x41263010, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x41263010, dest, msg);
#line 59
}
#line 59
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x41263688, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x41263688, msg);
#line 95
}
#line 95
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x4122caa0){
#line 92
  switch (arg_0x4122caa0) {
#line 92
...
#line 92
    default:
#line 92
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x4122caa0);
#line 92
      break;
#line 92
    }
...
#line 119
{
  printf("SendA = %u;SendB = %u;SendC = %u;SendD = %u;SendE = %u;\n", ConInTagC__SendA, ConInTagC__SendB, ConInTagC__SendC, ConInTagC__SendD, ConInTagC__SendE);
  printfflush();
}
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x41187030){
#line 72
  switch (arg_0x41187030) {
#line 72
    case 1U:
#line 72
      ConInTagC__Timer0__fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x41187030);
#line 72
      break;
#line 72
    }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x412655b8, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x412655b8, msg, payload, len);
#line 67
...
inline static void ConInTagC__Leds__led1Toggle(void ){
#line 72
...
# 56 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
inline static void ConInTagC__Leds__led0Toggle(void ){
#line 56
...
#line 56
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t ConInTagC__AMSendControl__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 69
...
#line 65
{
  return /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__getPayload(m, len);
}

# 124 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void * ConInTagC__AMSendControl__getPayload(message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__getPayload(msg, len);
#line 124
...
#line 40
{
  ...
  if (len == sizeof(car_send_msg_t )) {
      ...
      car_send_msg_t *car_send_msg = (car_send_msg_t *)ConInTagC__AMSendControl__getPayload(&ConInTagC__car_pkt, sizeof(car_send_msg_t ));

#line 48
      __nesc_hton_uint8(car_send_msg->control.nxdata, __nesc_ntoh_uint8(car_payload->control.nxdata));
      __nesc_hton_uint16(car_send_msg->value.nxdata, __nesc_ntoh_uint16(car_payload->value.nxdata));

      printf("control = %u value = %u \n", __nesc_ntoh_uint8(car_send_msg->control.nxdata), __nesc_ntoh_uint16(car_send_msg->value.nxdata));
      printfflush();


      if (ConInTagC__AMSendControl__send(10, &ConInTagC__car_pkt, sizeof(car_send_msg_t )) != SUCCESS) {
          ConInTagC__Leds__led0Toggle();
        }
      else 
#line 57
        {
          ...
          printfflush();
          ConInTagC__Leds__led1Toggle();
        }


      if (TOS_NODE_ID == 1) {
          ConInTagC__SendD++;
          if (ConInTagC__AMSendControl__send(2, &ConInTagC__car_pkt, sizeof(car_send_msg_t )) != SUCCESS) {
              ConInTagC__Leds__led0Toggle();
            }
          else 
#line 68
...
inline static void ConInTagC__Leds__led2Toggle(void ){
#line 89
...
#line 89
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t ConInTagC__AMSendTag__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__send(addr, msg, len);
#line 69
...
# 114 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void * /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__getPayload(message_t * msg, uint8_t len){
#line 114
  void *__nesc_result;
#line 114
...
#line 65
{
  return /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__getPayload(m, len);
}

# 124 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void * ConInTagC__AMSendTag__getPayload(message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMSend__getPayload(msg, len);
#line 124
...
#line 78
{
  ...
  if (len == sizeof(tag_msg_t )) {
      ...
      tag_msg_t *tag_msg = (tag_msg_t *)ConInTagC__AMSendTag__getPayload(&ConInTagC__tag_pkt, sizeof(tag_msg_t ));
...
#line 86
      ...
      printf("tagid = %u value = %u \n", __nesc_ntoh_uint16(tag_msg->tagid.nxdata), __nesc_ntoh_uint16(tag_msg->value.nxdata));
      printfflush();


      if (TOS_NODE_ID == 2) {
          ConInTagC__SendE++;
          if (ConInTagC__AMSendTag__send(1, &ConInTagC__tag_pkt, sizeof(tag_msg_t )) != SUCCESS) {
              ConInTagC__Leds__led0Toggle();
            }
          else 
#line 97
            {
              ...
              printfflush();
              ConInTagC__Leds__led2Toggle();
            }
        }

      if (ConInTagC__AMSendTag__send(0, &ConInTagC__tag_pkt, sizeof(tag_msg_t )) != SUCCESS) {
          ConInTagC__Leds__led0Toggle();
        }
      else 
#line 106
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x41266e58, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x41266e58) {
#line 67
    case 153:
#line 67
      __nesc_result = ConInTagC__AMReceiveTag__receive(msg, payload, len);
#line 67
      break;
#line 67
    case 187:
#line 67
      __nesc_result = ConInTagC__AMReceiveControl__receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x41266e58, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
#line 92
#line 151
inline static void /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
...
#line 151
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static error_t /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
#line 83
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
  CC2420ActiveMessageP__AMPacket__setDestination(amsg, addr);
#line 92
}
#line 92
#line 151
inline static void /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
  CC2420ActiveMessageP__AMPacket__setType(amsg, t);
#line 151
}
#line 151
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static error_t /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x40e93648){
#line 92
  switch (arg_0x40e93648) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x40e93648);
#line 92
      break;
#line 92
    }
...
# 71 "/opt/tinyos-2.1.1/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x40ec3b78, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x40ec3b78) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x40ec3b78, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x41263688, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x41263688, msg);
#line 81
}
#line 81
...
#line 89
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x41266498, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__sendDone(arg_0x41266498, msg, error);
#line 99
}
#line 99
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
...
#line 117
  ConInTagC__RadioControl__stopDone(error);
#line 117
}
#line 117
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
inline static error_t ConInTagC__RadioControl__start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
#line 33
{
  if (err != SUCCESS) 
    {
#line 35
      ConInTagC__RadioControl__start();
    }
}
...
#line 92
  ConInTagC__RadioControl__startDone(error);
#line 92
}
#line 92
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
...
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void ConInTagC__Timer0__startPeriodic(uint32_t dt){
#line 53
...
#line 28
{
  ConInTagC__Timer0__startPeriodic(3000);
  ConInTagC__RadioControl__start();
}
...
#line 47
{
  /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setDestination(msg, dest);
  /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__AMPacket__setType(msg, 153);
  return /*ConInTagAppC.AMSenderTag.SenderC.AMQueueEntryP*/AMQueueEntryP__2__Send__send(msg, len);
}
...
# 114 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static void * /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__getPayload(message_t * msg, uint8_t len){
#line 114
  void *__nesc_result;
#line 114
...
#line 47
{
  /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 187);
  return /*ConInTagAppC.AMSenderControl.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}
