...
extern void *memset(void *arg_0x402d1e90, int arg_0x402d4010, size_t arg_0x402d41a8);
#line 63
extern void *memset(void *arg_0x402dfd30, int arg_0x402dfe88, size_t arg_0x402de030);
...
struct _reent {
  ...
  void (*__cleanup)(struct _reent *arg_0x403013b8);
  ...
  void (**_sig_func)(int arg_0x402ffa70);
...
typedef nx_struct car_send_msg {
  nx_uint8_t control;
  nx_uint16_t value;
} __attribute__((packed)) car_send_msg_t;
...
typedef nx_struct tag_msg {
  nx_uint16_t tagid;
  nx_uint16_t value;
} __attribute__((packed)) tag_msg_t;
...
typedef TMilli ConInCarC__Timer0__precision_tag;
...
enum /*CarC.Resourceusart0*/Msp430Uart0C__0____nesc_unnamed4301 {
...
enum /*CarC.Resourceusart0.UsartC*/Msp430Usart0C__0____nesc_unnamed4302 {
...
static void ConInCarC__Timer0__fired(void );
# 49 "/opt/tinyos-2.1.1/tos/interfaces/Boot.nc"
static void ConInCarC__Boot__booted(void );
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void ConInCarC__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 92 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static void ConInCarC__RadioControl__startDone(error_t error);
#line 117
static void ConInCarC__RadioControl__stopDone(error_t error);
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
static 
#line 63
message_t * 
...
uint8_t len);
# 92 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static void ConInCarC__CarControl__startDone(error_t error);
# 9 "Car.nc"
static void ConInCarC__Car__readDone(error_t state, uint16_t data);
# 34 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430Compare.nc"
...
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
/*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static void /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(
#line 85
message_t * msg, 
...
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
static void ConInCarC__Timer0__startPeriodic(uint32_t dt);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static error_t ConInCarC__AMSend__send(am_addr_t addr, 
#line 60
message_t * msg, 
...
uint8_t len);
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
static error_t ConInCarC__RadioControl__start(void );
#line 83
static error_t ConInCarC__CarControl__start(void );
# 6 "Car.nc"
static error_t ConInCarC__Car__Back(uint16_t value);
static error_t ConInCarC__Car__QuiryReader(uint8_t value);
static error_t ConInCarC__Car__Pause(void );
#line 5
static error_t ConInCarC__Car__Forward(uint16_t value);
#line 4
static error_t ConInCarC__Car__Angle(uint16_t value);
# 56 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
static void ConInCarC__Leds__led0Toggle(void );
#line 72
static void ConInCarC__Leds__led1Toggle(void );
#line 89
static void ConInCarC__Leds__led2Toggle(void );
# 22 "ConInCarC.nc"
message_t ConInCarC__tag_pkt;
uint16_t ConInCarC__tagid;
uint16_t ConInCarC__data[15];
uint16_t ConInCarC__hint = 0;

uint8_t ConInCarC__j = 0;
uint8_t ConInCarC__index;

static inline void ConInCarC__CarCommand(uint8_t control, uint16_t value);
#line 79
static inline void ConInCarC__Boot__booted(void );
...
static inline void ConInCarC__RadioControl__startDone(error_t err);





static inline void ConInCarC__RadioControl__stopDone(error_t err);

static inline void ConInCarC__CarControl__startDone(error_t error);




static void ConInCarC__Car__readDone(error_t err, uint16_t value);
#line 136
static inline message_t *ConInCarC__AMReceive__receive(message_t *msg, void *p, uint8_t len);
#line 153
static inline void ConInCarC__AMSend__sendDone(message_t *m, error_t err);
...
static inline void ConInCarC__Timer0__fired(void );
# 30 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430Compare.nc"
...
#line 188
static inline error_t CarP__Car__QuiryReader(uint8_t value);
#line 214
...
message_t *msg);
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
static void /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
static error_t /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(
#line 56
message_t * msg, 
...
/*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__getPayload(
#line 111
message_t * msg, 
...
uint8_t len);
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
static void /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(
#line 147
message_t * amsg, 
...
am_id_t t);
# 45 "/opt/tinyos-2.1.1/tos/system/AMQueueEntryP.nc"
static error_t /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(message_t *m, error_t err);
...
static inline void */*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__getPayload(message_t *m, uint8_t len);
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
...
# 28 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x40663ce8){
#line 28
  switch (arg_0x40663ce8) {
#line 28
    case 0:
#line 28
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x40663ce8);
#line 28
      break;
#line 28
    }
...
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x41059388){
#line 110
  unsigned char __nesc_result;
#line 110

#line 110
  switch (arg_0x41059388) {
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x41059388);
#line 110
      break;
#line 110
    }
...
# 55 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0x40ae2a58){
#line 55
  switch (arg_0x40ae2a58) {
#line 55
    case /*CarC.Resourceusart0.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 55
...
#line 55
    default:
#line 55
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__unconfigure(arg_0x40ae2a58);
#line 55
      break;
#line 55
    }
...
# 88 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x412ba4b8, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x412ba4b8, msg);
#line 88
}
#line 88
...
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x41059388){
#line 118
  unsigned char __nesc_result;
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x41059388);
#line 118
      break;
#line 118
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x41059dd8){
#line 39
  union __nesc_unnamed4279 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x41059dd8);
#line 39
...
# 49 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x40ae2a58){
#line 49
  switch (arg_0x40ae2a58) {
#line 49
    case /*CarC.Resourceusart0.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0x40ae2a58);
#line 49
      break;
#line 49
    }
...
# 51 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__immediateRequested(uint8_t arg_0x40ae3690){
#line 51
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__immediateRequested(arg_0x40ae3690);
#line 51
}
#line 51
...
# 87 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x41059388){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x41059388);
#line 87
      break;
#line 87
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart0P.UartP*/Msp430UartP__1__Msp430UartConfigure__getConfig(uint8_t arg_0x408c11b8){
#line 39
  union __nesc_unnamed4283 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430Uart0P.UartP*/Msp430UartP__1__Msp430UartConfigure__default__getConfig(arg_0x408c11b8);
#line 39
...
#line 174
# 280 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430Usart0P.nc"
static inline void HplMsp430Usart0P__configUart(msp430_uart_union_config_t *config)
#line 280
{
...
# 78 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x41059388){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x41059388);
#line 78
      break;
#line 78
    }
...
# 43 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__requested(uint8_t arg_0x40ae3690){
#line 43
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__requested(arg_0x40ae3690);
#line 43
}
#line 43
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(message_t * msg, error_t error){
#line 99
  ConInCarC__AMSend__sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__sendDone(m, err);
}
...
#line 89
    case 0U:
#line 89
      /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__sendDone(msg, error);
#line 89
      break;
#line 89
    default:
...
#line 151
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x40b58908, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__send(arg_0x40b58908, addr, msg, len);
#line 69
...
# 23 "/opt/tinyos-2.1.1/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__dataLinkLength(uart_id_t arg_0x40816b10, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char __nesc_result;
#line 23

#line 23
  switch (arg_0x40816b10) {
#line 23
...
#line 23
    default:
#line 23
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__dataLinkLength(arg_0x40816b10, msg, upperLen);
#line 23
      break;
#line 23
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__offset(uart_id_t arg_0x40816b10){
#line 15
  unsigned char __nesc_result;
#line 15
...
#line 15
    default:
#line 15
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__offset(arg_0x40816b10);
#line 15
      break;
#line 15
    }
...
#line 56
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__send(am_id_t arg_0x40b58908, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x40b58908, addr, msg, len);
#line 69
...
# 59 "/opt/tinyos-2.1.1/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x412bbe20, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x412bbe20, dest, msg);
#line 59
}
#line 59
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
...
#line 42
# 303 "/usr/lib/i386-linux-gnu/ncc/nesc_nx.h"
static __inline  int8_t __nesc_hton_int8(void * target, int8_t value)
#line 303
{
#line 303
...
# 95 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x412ba4b8, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x412ba4b8, msg);
#line 95
}
#line 95
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x4127e628){
#line 92
  switch (arg_0x4127e628) {
#line 92
...
#line 92
    default:
#line 92
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x4127e628);
#line 92
      break;
#line 92
    }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x412bc490, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x412bc490, msg, payload, len);
#line 67
...
inline static void ConInCarC__Leds__led1Toggle(void ){
#line 72
...
inline static void ConInCarC__Leds__led2Toggle(void ){
#line 89
...
# 53 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void ConInCarC__Timer0__startPeriodic(uint32_t dt){
#line 53
...
# 78 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartResource__request(uint8_t arg_0x408c3718){
#line 78
  unsigned char __nesc_result;
#line 78

#line 78
  switch (arg_0x408c3718) {
#line 78
    case /*CarC.Resourceusart0*/Msp430Uart0C__0__CLIENT_ID:
#line 78
      __nesc_result = /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__request(/*CarC.Resourceusart0.UsartC*/Msp430Usart0C__0__CLIENT_ID);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartResource__default__request(arg_0x408c3718);
#line 78
      break;
#line 78
    }
...
# 7 "Car.nc"
inline static error_t ConInCarC__Car__QuiryReader(uint8_t value){
#line 7
  unsigned char __nesc_result;
#line 7
...
# 8 "Car.nc"
inline static error_t ConInCarC__Car__Pause(void ){
#line 8
  unsigned char __nesc_result;
#line 8
...
# 5 "Car.nc"
inline static error_t ConInCarC__Car__Forward(uint16_t value){
#line 5
  unsigned char __nesc_result;
#line 5
...
# 4 "Car.nc"
inline static error_t ConInCarC__Car__Angle(uint16_t value){
#line 4
  unsigned char __nesc_result;
#line 4
...
# 6 "Car.nc"
inline static error_t ConInCarC__Car__Back(uint16_t value){
#line 6
  unsigned char __nesc_result;
#line 6
...
#line 92
  ConInCarC__CarControl__startDone(error);
#line 92
}
#line 92
# 111 "CarP.nc"
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
inline static error_t ConInCarC__CarControl__start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
static inline void ConInCarC__CarCommand(uint8_t control, uint16_t value)
{
  switch (control) {
      case 209: 
        {
          ConInCarC__CarControl__start();
          break;
        }
      case 210: 
        {
          ConInCarC__Car__Back(value);
          break;
        }
      case 211: 
        {
          ConInCarC__Car__Angle(value);
          break;
        }

      case 213: 
        {
          ConInCarC__Car__Forward(value);
          break;
        }
      case 214: 
        {
          ConInCarC__Car__Pause();
          break;
        }
      case 215: 
        {
          ConInCarC__tagid = value;
          ConInCarC__Car__QuiryReader(ConInCarC__tagid);
          break;
        }
      case 255: 
        {
          ...
          ConInCarC__Timer0__startPeriodic(500);
          ConInCarC__Leds__led2Toggle();
          break;
        }
      default: 
        break;
...
static inline message_t *ConInCarC__AMReceive__receive(message_t *msg, void *p, uint8_t len)
{
  ...
  if (len == sizeof(car_send_msg_t )) {
      ...
      do {
#line 143
          printf("car control %u %u\n", __nesc_ntoh_uint8(radio_payload->control.nxdata), __nesc_ntoh_uint16(radio_payload->value.nxdata));
#line 143
          printfflush();
        }
      while (
#line 143
      ...
      ConInCarC__CarCommand(__nesc_ntoh_uint8(radio_payload->control.nxdata), __nesc_ntoh_uint16(radio_payload->value.nxdata));

      ConInCarC__Leds__led1Toggle();
    }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x412bedb8, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x412bedb8) {
#line 67
    case 187:
#line 67
      __nesc_result = ConInCarC__AMReceive__receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x412bedb8, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 71 "/opt/tinyos-2.1.1/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x4105ab78, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x4105ab78) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x4105ab78, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 71 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x4100d010, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x4100d010) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x4100d010, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x412ba4b8, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x412ba4b8, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.1.1/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x4100d010, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x4100d010) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x4100d010, data, length, error);
#line 91
      break;
#line 91
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x4100e558){
#line 92
  switch (arg_0x4100e558) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP__Resource__default__granted(arg_0x4100e558);
#line 92
      break;
#line 92
    }
...
#line 89
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x412be3f8, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__sendDone(arg_0x412be3f8, msg, error);
#line 99
}
#line 99
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
...
#line 117
  ConInCarC__RadioControl__stopDone(error);
#line 117
}
#line 117
...
# 83 "/opt/tinyos-2.1.1/tos/interfaces/SplitControl.nc"
inline static error_t ConInCarC__RadioControl__start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
{
  if (err != SUCCESS) {
    ConInCarC__RadioControl__start();
    }
}
...
#line 92
  ConInCarC__RadioControl__startDone(error);
#line 92
}
#line 92
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
...
static inline void CarP__uart0resource__granted(void )
{
  ...
  U0CTL &= ~0x04;
  CarP__SendString(CarP__CarCommand, 7);
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart0P.UartP*/Msp430UartP__1__Resource__granted(uint8_t arg_0x408a4108){
#line 92
  switch (arg_0x408a4108) {
#line 92
    case /*CarC.Resourceusart0*/Msp430Uart0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430Uart0P.UartP*/Msp430UartP__1__Resource__default__granted(arg_0x408a4108);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x4105d648){
#line 92
  switch (arg_0x4105d648) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x4105d648);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0x40ae4bd0){
#line 92
  switch (arg_0x40ae4bd0) {
#line 92
    case /*CarC.Resourceusart0.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__default__granted(arg_0x40ae4bd0);
#line 92
      break;
#line 92
    }
...
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartResource__release(uint8_t arg_0x408c3718){
#line 110
  unsigned char __nesc_result;
#line 110
...
#line 110
    case /*CarC.Resourceusart0*/Msp430Uart0C__0__CLIENT_ID:
#line 110
      __nesc_result = /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__release(/*CarC.Resourceusart0.UsartC*/Msp430Usart0C__0__CLIENT_ID);
#line 110
      break;
#line 110
    default:
#line 110
      __nesc_result = /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartResource__default__release(arg_0x408c3718);
#line 110
      break;
#line 110
    }
...
#line 9
  ConInCarC__Car__readDone(state, data);
#line 9
}
#line 9
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
# 151 "/opt/tinyos-2.1.1/tos/interfaces/AMPacket.nc"
inline static void /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(message_t * amsg, am_id_t t){
#line 151
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static error_t /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
# 56 "/opt/tinyos-2.1.1/tos/interfaces/Leds.nc"
inline static void ConInCarC__Leds__led0Toggle(void ){
#line 56
...
#line 56
# 69 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static error_t ConInCarC__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__send(addr, msg, len);
#line 69
...
inline static void * /*AMQueueP.AMQueueImplP*/AMQueueImplP__1__AMSend__getPayload(am_id_t arg_0x40b58908, message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = CC2420ActiveMessageP__AMSend__getPayload(arg_0x40b58908, msg, len);
#line 124
...
# 114 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void * /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__getPayload(message_t * msg, uint8_t len){
#line 114
  void *__nesc_result;
#line 114
...
#line 65
{
  return /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__getPayload(m, len);
}

# 124 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void * ConInCarC__AMSend__getPayload(message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMSend__getPayload(msg, len);
#line 124
...
#line 160
{
  ...
  if (ConInCarC__j < 15) {
      TagMsg *msg = (TagMsg *)ConInCarC__AMSend__getPayload(&ConInCarC__tag_pkt, sizeof(TagMsg ));

      __nesc_hton_uint16(msg->tagid.nxdata, 100 + ConInCarC__j);
      __nesc_hton_uint16(msg->tagdata.nxdata, ConInCarC__data[ConInCarC__j++]);
      __nesc_hton_uint16(msg->hint.nxdata, ConInCarC__hint);

      do {
#line 169
          printf("Tag Data %u\n", __nesc_ntoh_uint16(msg->tagdata.nxdata));
#line 169
          printfflush();
        }
      while (
#line 169
      ...
      if (ConInCarC__AMSend__send(AM_BROADCAST_ADDR, &ConInCarC__tag_pkt, sizeof(TagMsg )) != SUCCESS) {
          ConInCarC__Leds__led0Toggle();
        }
    }
}
...
# 72 "/opt/tinyos-2.1.1/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x40c904f8){
#line 72
  switch (arg_0x40c904f8) {
#line 72
    case 0U:
#line 72
      ConInCarC__Timer0__fired();
#line 72
      break;
#line 72
    case 1U:
...
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x40c904f8);
#line 72
      break;
#line 72
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__granted(uint8_t arg_0x408a4108){
#line 92
  switch (arg_0x408a4108) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__default__granted(arg_0x408a4108);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x40ae4bd0){
#line 92
  switch (arg_0x40ae4bd0) {
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x40ae4bd0);
#line 92
      break;
#line 92
    }
...
# 49 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x40ae2a58){
#line 49
  switch (arg_0x40ae2a58) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x40ae2a58);
#line 49
      break;
#line 49
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__getConfig(uint8_t arg_0x408c11b8){
#line 39
  union __nesc_unnamed4283 *__nesc_result;
#line 39

#line 39
  switch (arg_0x408c11b8) {
#line 39
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__default__getConfig(arg_0x408c11b8);
#line 39
      break;
#line 39
    }
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__sendDone(am_id_t arg_0x40753ae8, message_t * msg, error_t error){
#line 99
  /*SerialAMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x40753ae8, msg, error);
#line 99
}
#line 99
...
# 89 "/opt/tinyos-2.1.1/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0x40816010, message_t * msg, error_t error){
#line 89
  switch (arg_0x40816010) {
#line 89
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 89
...
#line 89
    default:
#line 89
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0x40816010, msg, error);
#line 89
      break;
#line 89
    }
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__receive(am_id_t arg_0x4075e548, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__default__receive(arg_0x4075e548, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.1.1/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0x40819918, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x40819918) {
#line 67
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0x40819918, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 31 "/opt/tinyos-2.1.1/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__upperLength(uart_id_t arg_0x40816b10, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char __nesc_result;
#line 31
...
#line 31
    default:
#line 31
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__upperLength(arg_0x40816b10, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
# 55 "/opt/tinyos-2.1.1/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x40ae2a58){
#line 55
  switch (arg_0x40ae2a58) {
#line 55
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 55
    default:
#line 55
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x40ae2a58);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__release(uint8_t arg_0x408c3718){
#line 110
  unsigned char __nesc_result;
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__release(arg_0x408c3718);
#line 110
      break;
#line 110
    }
...
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__isOwner(uint8_t arg_0x408c3718){
#line 118
  unsigned char __nesc_result;
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__isOwner(arg_0x408c3718);
#line 118
      break;
#line 118
    }
...
# 51 "/opt/tinyos-2.1.1/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x40ae3690){
#line 51
    /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x40ae3690);
#line 51
}
#line 51
# 90 "/opt/tinyos-2.1.1/tos/system/ArbiterP.nc"
...
# 87 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__immediateRequest(uint8_t arg_0x408c3718){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__immediateRequest(arg_0x408c3718);
#line 87
      break;
#line 87
    }
...
# 79 "/opt/tinyos-2.1.1/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receivedByte(uint8_t arg_0x408a32c8, uint8_t byte){
#line 79
  switch (arg_0x408a32c8) {
#line 79
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receivedByte(arg_0x408a32c8, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receiveDone(uint8_t arg_0x408a32c8, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0x408a32c8) {
#line 99
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receiveDone(arg_0x408a32c8, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x40aa0ce8, uint8_t data){
#line 54
  switch (arg_0x40aa0ce8) {
#line 54
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x40aa0ce8, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__sendDone(uint8_t arg_0x408a32c8, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0x408a32c8) {
#line 57
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__sendDone(arg_0x408a32c8, buf, len, error);
#line 57
      break;
#line 57
    }
...
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x40aa0ce8){
#line 49
  switch (arg_0x40aa0ce8) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x40aa0ce8);
#line 49
      break;
#line 49
    }
...
# 118 "/opt/tinyos-2.1.1/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartResource__isOwner(uint8_t arg_0x408c3718){
#line 118
  unsigned char __nesc_result;
#line 118
...
#line 118
    case /*CarC.Resourceusart0*/Msp430Uart0C__0__CLIENT_ID:
#line 118
      __nesc_result = /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__1__Resource__isOwner(/*CarC.Resourceusart0.UsartC*/Msp430Usart0C__0__CLIENT_ID);
#line 118
      break;
#line 118
    default:
#line 118
      __nesc_result = /*Msp430Uart0P.UartP*/Msp430UartP__1__UsartResource__default__isOwner(arg_0x408c3718);
#line 118
      break;
#line 118
    }
...
# 79 "/opt/tinyos-2.1.1/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart0P.UartP*/Msp430UartP__1__UartStream__receivedByte(uint8_t arg_0x408a32c8, uint8_t byte){
#line 79
    /*Msp430Uart0P.UartP*/Msp430UartP__1__UartStream__default__receivedByte(arg_0x408a32c8, byte);
#line 79
}
#line 79
# 222 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430UartP.nc"
...
# 99 "/opt/tinyos-2.1.1/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart0P.UartP*/Msp430UartP__1__UartStream__receiveDone(uint8_t arg_0x408a32c8, uint8_t * buf, uint16_t len, error_t error){
#line 99
    /*Msp430Uart0P.UartP*/Msp430UartP__1__UartStream__default__receiveDone(arg_0x408a32c8, buf, len, error);
#line 99
}
#line 99
# 134 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/Msp430UartP.nc"
...
# 54 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__rxDone(uint8_t arg_0x40aa0ce8, uint8_t data){
#line 54
  switch (arg_0x40aa0ce8) {
#line 54
    case /*CarC.Resourceusart0.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__rxDone(arg_0x40aa0ce8, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__I2CInterrupts__fired(uint8_t arg_0x40ac1cf8){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__I2CInterrupts__default__fired(arg_0x40ac1cf8);
#line 39
}
#line 39
...
# 57 "/opt/tinyos-2.1.1/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart0P.UartP*/Msp430UartP__1__UartStream__sendDone(uint8_t arg_0x408a32c8, uint8_t * buf, uint16_t len, error_t error){
#line 57
    /*Msp430Uart0P.UartP*/Msp430UartP__1__UartStream__default__sendDone(arg_0x408a32c8, buf, len, error);
#line 57
}
#line 57
# 224 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430Usart.nc"
...
# 49 "/opt/tinyos-2.1.1/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__txDone(uint8_t arg_0x40aa0ce8){
#line 49
  switch (arg_0x40aa0ce8) {
#line 49
    case /*CarC.Resourceusart0.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__txDone(arg_0x40aa0ce8);
#line 49
      break;
#line 49
    }
...
# 28 "/opt/tinyos-2.1.1/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x40663ce8){
#line 28
  switch (arg_0x40663ce8) {
#line 28
    case 0:
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x40663ce8);
#line 28
      break;
#line 28
    }
...
# 64 "/opt/tinyos-2.1.1/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x405cd4a0){
#line 64
  switch (arg_0x405cd4a0) {
#line 64
    case SerialP__RunTx:
#line 64
...
#line 64
    default:
#line 64
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x405cd4a0);
#line 64
      break;
#line 64
    }
...
#line 100
{
  ...
  if (err == SUCCESS) {
      ...
      msg = (TagMsg *)ConInCarC__AMSend__getPayload(&ConInCarC__tag_pkt, sizeof(TagMsg ));

      __nesc_hton_uint16(msg->tagid.nxdata, ConInCarC__tagid);
      __nesc_hton_uint16(msg->tagdata.nxdata, value);
      __nesc_hton_uint16(msg->hint.nxdata, 0);
...
#line 112
      ...
      ConInCarC__index = ConInCarC__tagid - 100;
      ConInCarC__data[ConInCarC__index] = value;
      ConInCarC__Leds__led2Toggle();

      if (ConInCarC__AMSend__send(0xffff, &ConInCarC__tag_pkt, sizeof(TagMsg )) == SUCCESS) {
          ConInCarC__Leds__led0Toggle();
        }
    }
}
...
#line 47
{
  /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setDestination(msg, dest);
  /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__AMPacket__setType(msg, 153);
  return /*ConInCarAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__1__Send__send(msg, len);
}
